...
const updatePage = async () => {
  ...
  const extract = fruitsArray.filter(fruit => fruit.nutritions.sugar > 15);

  const mapped = extract.map(extract => extract.name)

  // TODO: Create a new HTML element to display your data: done in index.html

  // TODO: Append your new element to the page
  const element = document.getElementById("new");
  element.append("Name of all fruits whose sugar > 15: ", mapped.join(', '));
